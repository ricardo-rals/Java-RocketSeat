package br.com.rals.todolist.task;
...
import br.com.rals.todolist.utils.Utils;
...
public class TaskController {
    ...
    public ResponseEntity<?> update(@RequestBody TaskModel taskModel,@PathVariable UUID  id, HttpServletRequest request ) {
        ...
        if (!task.getIdUser().equals(idUser)) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Usuário não tem eprmissão para alterar essa tarefa");
        }
